...
AUTO_LOAD = ['xiaomi_ble']  # TODO: Remove?

govee_ns = cg.esphome_ns.namespace('govee')
Govee = govee_ns.class_('Govee', esp32_ble_tracker.ESPBTDeviceListener,
                        cg.Component)

CONFIG_SCHEMA = cv.Schema({
    cv.GenerateID(): cv.declare_id(Govee),
